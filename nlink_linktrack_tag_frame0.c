...
//    assert(sizeof(tagFrame0Data_.frame) == kFrameLength);
    ...
    int24ToFloat(tagFrame0Data_.frame.posTemp, tagFrame0Data_.pos,
                 sizeof(tagFrame0Data_.pos) / sizeof(tagFrame0Data_.pos[0]),
                 kPosMultiply_);

    int24ToFloat(tagFrame0Data_.frame.velTemp, tagFrame0Data_.vel,
                 sizeof(tagFrame0Data_.vel) / sizeof(tagFrame0Data_.vel[0]),
                 kVelMultiply_);

    int24ToFloat(tagFrame0Data_.frame.disTemp, tagFrame0Data_.dis,
                 sizeof(tagFrame0Data_.dis) / sizeof(tagFrame0Data_.dis[0]),
                 kDisMultiply_);

    int16ToFloat(tagFrame0Data_.frame.angleTemp, tagFrame0Data_.angle,
                 sizeof(tagFrame0Data_.angle) / sizeof(tagFrame0Data_.angle[0]),
                 kAngleMultiply_);
    uint8ToFloat(tagFrame0Data_.frame.eopTemp, tagFrame0Data_.eop,
                 sizeof(tagFrame0Data_.eop) / sizeof(tagFrame0Data_.eop[0]),
                 kEopMultiply_);
    tagFrame0Data_.supplyVoltage = tagFrame0Data_.frame.supplyVoltageTemp/kVoltageMultiply_;
